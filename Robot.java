...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    myRobot.tankDrive(xboxController.getLeftY(),xboxController.getLeftX());
    ...
    System.out.println("enc2Tick: " + encoderJoint2.getPosition());
    ...
    double kp1 = 0.012;
    double kp2 = 0.15;
    double kp1Manual = 0.1;
    double kp2Manual = 0.6;
    //DEBUG
    System.out.println("enc1Ang: " + enc1Ang);
    System.out.println("enc2Ang: " + enc2Ang);
