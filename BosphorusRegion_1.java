...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    double enc1Ang = (encoderJoint1.getAbsolutePosition() * 360)-185; //sonradan değiştir
  ...
  // error'u çıkardım
   ...
   //  High Goal Koymadan Position
    ...
    if(xboxController.getBackButton() && quarter == false){
     
      quarter = true;
      myRobot.tankDrive(left.get()/4, right.get()/4);
      
    }
    else if(xboxController.getBackButton() && quarter == true){
      quarter = false;
      myRobot.tankDrive(left.get(), right.get());
    }
